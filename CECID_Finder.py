...
df2.User_Id__c.fillna(0, inplace=True)
df2.replace(0, np.nan , inplace=True)
df2.dropna(subset=['User_Id__c'],inplace=True)
df2['Full Name'] = df2['First_Name__c'] + df2['Last_Name__c']
df2 = df2[['Full Name', 'User_Id__c', 'Case_Number__c']]
...
temp.drop(['First Name', 'Last Name', 'Full Name', 'Case_Number__c'], axis=1, inplace=True)
